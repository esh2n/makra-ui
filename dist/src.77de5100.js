...
const o = t => new n("string" == typeof t ? t : t + "", e),
      r = (t, ...s) => {
  const o = 1 === t.length ? t[0] : s.reduce((e, s, n) => e + (t => {
  ...
  t ? e.adoptedStyleSheets = s.map(t => t instanceof CSSStyleSheet ? t : t.styleSheet) : s.forEach(t => {
    ...
    s.textContent = t.cssText, e.appendChild(s);
      ...
      i = t ? t => t : t => t instanceof CSSStyleSheet ? (t => {
  let e = "";
...
n.finalized = !0, n.elementProperties = new Map(), n.elementStyles = [], n.shadowRootOptions = {
  mode: "open"
}, null === (s = globalThis.reactiveElementPlatformSupport) || void 0 === s || s.call(globalThis, {
  ReactiveElement: n
}), (null !== (e = globalThis.reactiveElementVersions) && void 0 !== e ? e : globalThis.reactiveElementVersions = []).push("1.0.0-rc.4");
...
const s = globalThis.trustedTypes,
  ...
  for (let i = 0; i < s; i++) {
    ...
    for (; p < s.length && (d.lastIndex = p, u = d.exec(s), null !== u);) p = d.lastIndex, d === v ? "!--" === u[1] ? d = a : void 0 !== u[1] ? d = f : void 0 !== u[2] ? ($.test(u[2]) && (h = RegExp("</" + u[2], "g")), d = _) : void 0 !== u[3] && (d = _) : d === _ ? ">" === u[0] ? (d = null != h ? h : v, c = -1) : void 0 === u[1] ? c = -2 : (c = d.lastIndex - u[2].length, e = u[1], d = void 0 === u[3] ? _ : '"' === u[3] ? m : g) : d === m || d === g ? d = _ : d === a || d === f ? d = v : (d = _, h = void 0);
...
class V {
  constructor({
    ...
    if (this.el = V.createElement(v, e), C.currentNode = this.el.content, 2 === i) {
      const t = this.el.content,
            i = t.firstChild;
      i.remove(), t.append(...i.childNodes);
    }

    for (; null !== (l = C.nextNode()) && c.length < u;) {
      if (1 === l.nodeType) {
        if (l.hasAttributes()) {
          const t = [];
        ...
        if ($.test(l.tagName)) {
          ...
          if (i > 0) {
            ...
            for (let s = 0; s < i; s++) l.append(t[s], r()), C.nextNode(), c.push({
              type: 2,
              index: ++h
            });
...
class S {
  ...
  _$AI(t, i = this) {
    t = E(this, t, i), d(t) ? t === x || null == t || "" === t ? (this._$AH !== x && this._$AR(), this._$AH = x) : t !== this._$AH && t !== T && this.$(t) : void 0 !== t._$litType$ ? this.T(t) : void 0 !== t.nodeType ? this.S(t) : c(t) ? this.M(t) : this.$(t);
  }
...
exports._$LH = R;
null === (t = globalThis.litHtmlPlatformSupport) || void 0 === t || t.call(globalThis, V, S), (null !== (i = globalThis.litHtmlVersions) && void 0 !== i ? i : globalThis.litHtmlVersions = []).push("2.0.0-rc.5");
...
n.finalized = !0, n._$litElement$ = !0, null === (l = globalThis.litElementHydrateSupport) || void 0 === l || l.call(globalThis, {
  LitElement: n
}), null === (o = globalThis.litElementPlatformSupport) || void 0 === o || o.call(globalThis, {
  LitElement: n
});
const h = {
  _$AK: (t, e, i) => {
...
exports._$LE = h;
(null !== (r = globalThis.litElementVersions) && void 0 !== r ? r : globalThis.litElementVersions = []).push("3.0.0-rc.4");
...
var GradientText = /*#__PURE__*/function (_LitElement) {
  _inherits(GradientText, _LitElement);

  var _super = _createSuper(GradientText);
...
GradientText.styles = (0, _lit.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n        :host {\n            display: inline;\n            background:linear-gradient(\n            90deg,#2e4f8b 0%,#3e589d 35%,#8f619b 60%,#d0718f 70%);\n            -webkit-background-clip: text;\n            color: transparent;\n            font-weight: bold;\n        }\n    "])));

__decorate([(0, _decorators.property)({
  type: String
})], GradientText.prototype, "text", void 0);

exports.GradientText = GradientText = __decorate([(0, _decorators.customElement)('gradient-text')], GradientText);
},{"lit":"../node_modules/lit/index.js","lit/decorators.js":"../node_modules/lit/decorators.js"}],"components/LoadingButton.ts":[function(require,module,exports) {
"use strict";
...
var LoadingButton = /*#__PURE__*/function (_LitElement) {
  _inherits(LoadingButton, _LitElement);
  ...
  _createClass(LoadingButton, [{
    ...
    value: function _submit(e) {
      ...
      var submitButton = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('button');
    ...
    get: function get() {
      ...
      var buttonHeight = 48;
      return (0, _lit.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n            button {\n                width: 120px;\n                height: ", "px;\n                border-radius: 5px;\n                border: 2px solid ", ";\n                background-color: ", ";\n                color: white;\n                cursor: pointer;\n                display: flex;\n                justify-content: center;\n                align-items: center;\n                position: relative;\n            }\n            span,\n            svg {\n            position: absolute;\n            fill: transparent;\n            }\n\n            .submitting {\n            width: ", "px;\n            background-color: white;\n            border: 2px solid transparent;\n            border-radius: 100vh;\n            border-left: 2px solid ", ";\n            border-bottom: 2px solid ", ";\n            animation: spin 1.2s 0.3s both;\n            transition: 0.3s;\n            }\n\n            .submitting span {\n            color: transparent;\n            }\n\n            .submitting svg {\n            animation: check 0.5s 1.2s forwards;\n            }\n\n            @keyframes spin {\n            80% {\n                border: 2px solid transparent;\n                border-left: 2px solid ", ";\n            }\n            100% {\n                border: 2px solid ", ";\n                transform: rotate(1080deg);\n            }\n            }\n\n            @keyframes check {\n            to {\n                fill: ", ";\n            }\n            }\n\n        "])), buttonHeight, (0, _lit.unsafeCSS)(primaryColor), (0, _lit.unsafeCSS)(primaryColor), buttonHeight, (0, _lit.unsafeCSS)(primaryColor), (0, _lit.unsafeCSS)(primaryColor), (0, _lit.unsafeCSS)(primaryColor), (0, _lit.unsafeCSS)(primaryColor), (0, _lit.unsafeCSS)(primaryColor));
    }
  }]);
...
exports.LoadingButton = LoadingButton = __decorate([(0, _decorators.customElement)('loading-button')], LoadingButton);
},{"lit":"../node_modules/lit/index.js","lit/decorators.js":"../node_modules/lit/decorators.js"}],"index.ts":[function(require,module,exports) {
"use strict";

require("./components/GradientText");

require("./components/LoadingButton");
},{"./components/GradientText":"components/GradientText.ts","./components/LoadingButton":"components/LoadingButton.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "55869" + '/');
